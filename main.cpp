...
#define CCL_DEFAULT_FOLDER_LOCATION "/Users/Qiang/Dropbox/Coding/3DPrinting/3DPrintPlanner/Data/"
#else
#define CCL_DEFAULT_FOLDER_LOCATION     "C:/Users/Ryan/Desktop/LatticeModeling/latticemodeler/Data/"
///////////////////////////////////////////////////////////////////////////////////////////////
//
#ifdef _DEBUG
...
void menuFuncTPMSModeling() {
    QMeshPatch* newMesh;
    TPMSModeler modeler;
    modeler.readTPMSParameters(newMesh);
    modeler.sliceModelImplicit();

    if (!(_pDataBoard.m_polyMeshBody)) _pDataBoard.m_polyMeshBody = new PMBody;
    else _pGLK.DelDisplayObj2(_pDataBoard.m_polyMeshBody);
    _pDataBoard.m_polyMeshBody->meshList.AddTail(newMesh);
    printf("-----------------------------------------------\n");
...
void menuEvent(int idCommand)
{
    ...
    case _MENU_MESH_TPMS:{menuFuncTPMSModeling();
    }break;
...
int buildPopupMenu (void)
{
    ...
    glutAddMenuEntry("TPMS Modeling", _MENU_MESH_TPMS);
    glutAddMenuEntry("----", -1);
